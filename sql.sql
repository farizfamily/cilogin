...
--
-- Name: aktiv_po; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW aktiv_po AS
    SELECT a.mcs_id, a.mcs_date, a.mcs_number AS number, c.supplier_name, sum(b.qty) AS qty, sum(f.qty) AS receipt FROM (((mcs_headers a JOIN mcs_items b USING (mcs_id)) JOIN suppliers c USING (supplier_id)) LEFT JOIN (mcs_headers d JOIN mcs_items e USING (mcs_id)) f ON ((f.ref_id = a.mcs_id))) WHERE (a.transaction_type_id = 3) GROUP BY a.mcs_id, a.mcs_date, a.mcs_number, c.supplier_name;
...
--
-- Name: pr_list; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW pr_list AS
    SELECT a.mcs_id, a.mcs_date, a.mcs_number AS po_number, d.supplier_name, sum(b.qty) AS qty FROM (((mcs_headers a JOIN mcs_items b USING (mcs_id)) JOIN mcs_headers c ON ((c.mcs_id = a.ref_id))) JOIN suppliers d ON ((d.supplier_id = c.supplier_id))) WHERE (a.transaction_type_id = 4) GROUP BY a.mcs_id, a.mcs_date, a.mcs_number, d.supplier_name;
...
--
-- Name: prt_list; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE prt_list (
    mcs_id integer,
    mcs_date date,
    number character varying,
    supplier_name character varying,
    qty numeric,
    mcs_status_id integer
);
...
--
-- Name: recent_receipt; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW recent_receipt AS
    SELECT a.mcs_id, a.mcs_date, a.mcs_number AS number, c.supplier_name FROM ((mcs_headers a JOIN mcs_headers b ON ((b.mcs_id = a.ref_id))) JOIN suppliers c ON ((c.supplier_id = b.supplier_id))) WHERE ((a.transaction_type_id = 4) AND (a.mcs_status_id = 1)) ORDER BY a.mcs_date DESC LIMIT 30;
...
CREATE VIEW v_mcs_items AS
    SELECT a.mcs_item_id, a.time_stamp, a.created_by, a.mcs_id, a.stock_id, a.notes, a.qty, c.unit_name, b.group_id FROM ((mcs_items a JOIN stocks b USING (stock_id)) LEFT JOIN stock_units c USING (stock_unit_id));
...
CREATE VIEW v_stocks AS
    SELECT a.stock_id, a.time_stamp, a.created_by, a.stock_code, a.stock_name_id, a.size, a.stock_unit_id AS unit_id, a.group_id, a.sub_group_id, a.type_id, a.brand_id, a.active, b.stock_name FROM (stocks a JOIN stock_names b USING (stock_name_id)) ORDER BY a.stock_id;
...
INSERT INTO mcs_headers VALUES (9, '2015-02-18 22:32:28.078', 'dei', 'MCS201502/9', 1, 12, '2015-02-18', 1, NULL, NULL, NULL);
INSERT INTO mcs_headers VALUES (8, '2015-02-18 21:43:16.691', 'dei', 'MO201502/8', 1, 12, '2015-02-18', 2, 'catatan mo', NULL, NULL);
INSERT INTO mcs_headers VALUES (10, '2015-02-18 22:36:11.35', 'dei', 'MO201502/10', 1, 12, '2015-02-18', 2, NULL, NULL, NULL);
INSERT INTO mcs_headers VALUES (6, '2015-02-17 07:33:14.512', 'dei', 'PO201502/6', 1, NULL, '2015-02-17', 3, 'my po second', 2, NULL);
INSERT INTO mcs_headers VALUES (11, '2015-02-18 22:38:25.15', 'dei', 'PO201502/11', 1, NULL, '2015-02-18', 3, 'catatan po', 1, NULL);
INSERT INTO mcs_headers VALUES (12, '2015-02-18 22:55:24.979', 'dei', 'PO201502/12', 1, NULL, '2015-02-18', 3, NULL, 1, NULL);
INSERT INTO mcs_headers VALUES (7, '2015-02-18 07:00:34.661', 'dei', 'Purchase Receipt201502/7', 4, NULL, '2015-02-18', 4, 'terima barang', NULL, 6);
INSERT INTO mcs_headers VALUES (13, '2015-02-19 06:46:45.724', 'dei', 'PR201502/13', 1, NULL, '2015-02-19', 4, 'catatan saat rece', NULL, 12);
INSERT INTO mcs_headers VALUES (14, '2015-02-19 17:47:04.327', 'dei', 'PT201502/14', 0, NULL, '2015-02-19', 5, 'my po purchase return', NULL, 13);
...
INSERT INTO mcs_items VALUES (60, '2015-02-09 20:40:43.317', 'dei', 1, 52, 'na', 1.00, NULL);
INSERT INTO mcs_items VALUES (61, '2015-02-09 20:40:43.329', 'dei', 1, 136, 'nb', 2.00, NULL);
INSERT INTO mcs_items VALUES (62, '2015-02-09 20:40:43.339', 'dei', 1, 170, 'nc', 3.00, NULL);
INSERT INTO mcs_items VALUES (63, '2015-02-09 20:41:54.898', 'dei', 2, 52, 'mna', 1.00, NULL);
INSERT INTO mcs_items VALUES (64, '2015-02-09 20:41:54.9', 'dei', 2, 136, 'mnb', 2.00, NULL);
INSERT INTO mcs_items VALUES (65, '2015-02-09 20:41:54.91', 'dei', 2, 170, 'mnc', 3.00, NULL);
INSERT INTO mcs_items VALUES (66, '2015-02-10 00:19:21.149', 'dei', 3, 4, 'nb', 1.00, NULL);
INSERT INTO mcs_items VALUES (67, '2015-02-10 00:19:21.16', 'dei', 3, 481, 'nd', 2.00, NULL);
INSERT INTO mcs_items VALUES (68, '2015-02-10 00:19:21.164', 'dei', 3, 7, 'ne', 3.00, NULL);
INSERT INTO mcs_items VALUES (69, '2015-02-10 00:24:29.322', 'dei', 3, 52, 'nf', 1.00, NULL);
INSERT INTO mcs_items VALUES (70, '2015-02-16 20:45:36.161', 'dei', 4, 136, 'mikro bus', 1000000.00, NULL);
INSERT INTO mcs_items VALUES (71, '2015-02-16 20:45:36.251', 'dei', 4, 21, 'troly kaye', 800000.00, NULL);
INSERT INTO mcs_items VALUES (72, '2015-02-16 20:45:36.292', 'dei', 4, 204, 'mobil', 9000000.00, NULL);
INSERT INTO mcs_items VALUES (73, '2015-02-16 20:45:36.331', 'dei', 4, 510, 'toples kue', 100000.00, NULL);
INSERT INTO mcs_items VALUES (74, '2015-02-16 22:49:31.4', 'dei', 5, 52, NULL, 1.00, NULL);
INSERT INTO mcs_items VALUES (75, '2015-02-16 22:49:31.404', 'dei', 5, 136, NULL, 2.00, NULL);
INSERT INTO mcs_items VALUES (76, '2015-02-16 22:49:31.405', 'dei', 5, 170, NULL, 3.00, NULL);
INSERT INTO mcs_items VALUES (77, '2015-02-17 07:33:14.516', 'dei', 6, 2, 'test', 1.00, 1000000.00);
INSERT INTO mcs_items VALUES (78, '2015-02-17 07:33:14.52', 'dei', 6, 140, NULL, 1.00, 10000.00);
INSERT INTO mcs_items VALUES (79, '2015-02-18 07:00:34.822', 'dei', 7, 2, NULL, 1.00, NULL);
INSERT INTO mcs_items VALUES (80, '2015-02-18 21:43:16.89', 'dei', 8, 583, NULL, 10.00, NULL);
INSERT INTO mcs_items VALUES (81, '2015-02-18 21:43:16.895', 'dei', 8, 29, NULL, 1.00, NULL);
INSERT INTO mcs_items VALUES (82, '2015-02-18 21:43:16.896', 'dei', 8, 2, NULL, 5.00, NULL);
INSERT INTO mcs_items VALUES (83, '2015-02-18 22:32:28.125', 'dei', 9, 583, NULL, 1.00, NULL);
INSERT INTO mcs_items VALUES (84, '2015-02-18 22:32:28.136', 'dei', 9, 2, NULL, 1.00, NULL);
INSERT INTO mcs_items VALUES (85, '2015-02-18 22:36:11.358', 'dei', 10, 583, NULL, 1.00, NULL);
INSERT INTO mcs_items VALUES (86, '2015-02-18 22:38:25.157', 'dei', 11, 583, NULL, 1.00, 600000.00);
INSERT INTO mcs_items VALUES (87, '2015-02-18 22:55:25.003', 'dei', 12, 2, NULL, 1.00, 50000.00);
INSERT INTO mcs_items VALUES (88, '2015-02-19 06:46:45.751', 'dei', 13, 2, NULL, 1.00, NULL);
INSERT INTO mcs_items VALUES (89, '2015-02-19 17:47:04.341', 'dei', 14, 2, NULL, 1.00, NULL);
...
SELECT pg_catalog.setval('mcs_items_mcs_item_id_seq', 89, true);
...
INSERT INTO mcs_transaction_types VALUES (4, '2015-02-17 13:14:05.22', 'dei', 'Purchase Receipt', 'PR');
INSERT INTO mcs_transaction_types VALUES (5, '2015-02-19 13:51:06.967', 'dei', 'Purchase return', 'PT');
...
INSERT INTO menus VALUES (18, '2015-02-17 23:51:59.896', 'dei', 'Daftar PO', 'Purchase Order', 'pr', 'active_po_list', 'icon-truck', true);
INSERT INTO menus VALUES (20, '2015-02-18 07:07:41.359', 'dei', 'PR List', 'Purchase Order', 'pr', 'pr_list', 'icon-truck', true);
INSERT INTO menus VALUES (19, '2015-02-18 06:51:45.922', 'dei', 'New Purchase Receipt', 'Purchase Order', 'pr', 'create_pr', 'icon-truck', true);
INSERT INTO menus VALUES (21, '2015-02-19 12:10:46.297', 'dei', 'Purchase return', 'Purchase Order', 'preturn', 'purchase_return', 'icon-truck', true);
...
SELECT pg_catalog.setval('menus_menu_id_seq', 21, true);
...
INSERT INTO quotation_products VALUES (94, '2015-02-18 20:32:15.392', 'dei', 12, 'Panggung Harapan', 'seluas 100meter2', 1000000000.00);
...
SELECT pg_catalog.setval('quotation_products_quotation_product_id_seq', 94, true);
...
INSERT INTO quotations VALUES (12, '2015-02-18 20:32:15.215', 'dei', 'Q201502/12', 5, 0, '0', '2015-02-18', 'bnm9999', 'cnm09988', NULL, 'cash', 'stand', '10 * 5 m2', true, 1, 3, '2015-03-20', '2015-03-23', '2015-03-17', NULL, '2015-02-20', NULL, '2015-02-23', NULL, '2015-02-25', NULL, 2, NULL, 1, 9, 8, 'heave ho thieves and beggars
', 100000000.00, NULL);
...
INSERT INTO role_menu_maps VALUES (32, '2015-02-18 00:12:27.407', 'dei', 1, 18);
INSERT INTO role_menu_maps VALUES (33, '2015-02-18 07:07:53.124', 'dei', 1, 19);
INSERT INTO role_menu_maps VALUES (34, '2015-02-18 07:07:58.449', 'dei', 1, 20);
INSERT INTO role_menu_maps VALUES (35, '2015-02-19 13:41:48.982', 'dei', 1, 21);
...
SELECT pg_catalog.setval('role_menu_maps_id_seq', 35, true);
...
INSERT INTO stock_groups VALUES (0, '2015-02-18 19:07:17.528', 'dei', '-');
...
INSERT INTO stock_names VALUES (0, '2015-02-18 19:01:40.803', 'dei', '-');
...
INSERT INTO stocks VALUES (2, '2015-01-21 22:27:49.132', 'dei', NULL, 2, NULL, 21, 10, NULL, 3, 57, 1);
...
INSERT INTO stocks VALUES (0, '2015-02-18 19:01:47.165', 'dei', NULL, 0, NULL, NULL, NULL, NULL, 0, NULL, 1);
INSERT INTO stocks VALUES (583, '2015-02-02 01:07:11.481', 'dei', 'bk01', 583, '500ml', 1, 13, NULL, 9, 57, 1);
...
CREATE RULE "_RETURN" AS ON SELECT TO prt_list DO INSTEAD SELECT a.mcs_id, a.mcs_date, a.mcs_number AS number, e.supplier_name, sum(b.qty) AS qty, a.mcs_status_id FROM ((((mcs_headers a JOIN mcs_items b USING (mcs_id)) JOIN mcs_headers c ON ((c.mcs_id = a.ref_id))) JOIN mcs_headers d ON ((d.mcs_id = c.ref_id))) JOIN suppliers e ON ((e.supplier_id = d.supplier_id))) WHERE (a.transaction_type_id = 5) GROUP BY a.mcs_id, a.mcs_date, a.mcs_number, e.supplier_name;
